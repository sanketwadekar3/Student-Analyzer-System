...
class Ui_graph2(object):
	...
	def setupUi(self, graph2):
		...
		self.nextpage1.setGeometry(QtCore.QRect(850, 640, 151, 51))
	...
	def retranslateUi(self, graph2):
		...
		self.label_5.setText(_translate("graph2", "   10.  Supervise, hire, and mentor others."))
		self.label_2.setText(_translate("graph2", "7.  Help people during a natural disaster or emergency."))
		self.label_3.setText(_translate("graph2", "9.  A career that takes less than 2 years of education."))
		...
		self.label_7.setText(_translate("graph2", "   12.  Teach people new skills."))
		self.label_8.setText(_translate("graph2", ""))
		...
		self.label_6.setText(_translate("graph2", "11.  Develop lesson plans for classes."))
		...
		self.label_4.setText(_translate("graph2", "   8.  Ensure federal, state, and local laws are abided by."))
		self.label_9.setText(_translate("graph2", ""))

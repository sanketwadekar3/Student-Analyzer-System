...
#import matplotlib.pyplot.ticklabel_format(**kwargs)
...
class Ui_graph3(object):
	...
	def data1(self):
		...
		def data_graph():
			...
			plt.xticks(range(3),('Acadmics','Management','Creativity'))
			print(x)
			print(y)
			plt.legend()
			plt.show()
	...
	def setupUi(self, graph3):
		...
		self.finish.setGeometry(QtCore.QRect(850, 640, 151, 51))
	...
	def retranslateUi(self, graph3):
		...
		self.label_5.setText(_translate("graph3", "   16.  Write a blog post, magazine article, or novel."))
		...
		self.label_8.setText(_translate("graph3", ""))
		...
		self.label_2.setText(_translate("graph3", "  13. Critique art, music, or performances."))
		self.label_3.setText(_translate("graph3", "15.  Promote or market a brand new product."))
		...
		self.label_4.setText(_translate("graph3", " 14. Work as a performer, costume designer, or background artist."))
		...
		self.label_9.setText(_translate("graph3", ""))
		self.label_6.setText(_translate("graph3", "17.  Work that is physical (keeps my body active)."))
		...
		self.label_7.setText(_translate("graph3", "    18.  Design works of art for others to enjoy."))
